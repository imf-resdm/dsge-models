...
iz_real__ = (x(it_, 1)+x(it_, 2)+x(it_, 3)-x(it_, 4)-x(it_, 5)-x(it_, 6))/y(32);
int_repayment__ = x(it_, 73)+x(it_, 74);
...
T450 = params(74)/y(48);
T453 = y(3)/(1+params(25));
T670 = getPowerDeriv(T88,1/params(66),1);
T702 = 1+y(5)*T162*1/y(5)*2*(y(21)/y(5)-params(16)-params(25));
T723 = 1+y(6)*T134*1/y(6)*2*(y(22)/y(6)-params(17)-params(25));
T739 = getPowerDeriv(1+y(23)/y(10)-params(18)-params(25),params(47),1);
T746 = (y(23)*(T235+(y(23)-params(76)*(params(25)+params(18)))*1/y(10)*T739)-(params(76)*(params(25)+params(18))+T235*(y(23)-params(76)*(params(25)+params(18)))))/(y(23)*y(23));
T770 = T162*(y(21)/y(5)-params(16)-params(25))^2+y(5)*T162*2*(y(21)/y(5)-params(16)-params(25))*(-y(21))/(y(5)*y(5));
T801 = T134*(y(22)/y(6)-params(17)-params(25))^2+y(6)*T134*2*(y(22)/y(6)-params(17)-params(25))*(-y(22))/(y(6)*y(6));
T886 = (1+y(38))*y(55)/y(29)*1/y(56);
T893 = (1+y(38))*y(55)/y(29)*(-y(30))/(y(56)*y(56));
T906 = getPowerDeriv(T79,1/(1-params(21)),1);
T1010 = (-(params(3)/(1+params(3))/(1+y(20))));
T1031 = (-params(74))/(y(48)*y(48));
T1058 = (-(y(29)*params(74)))/(y(48)*y(48));
T1123 = (y(23)-params(76)*(params(25)+params(18)))*T739*(-y(23))/(y(10)*y(10))/y(23);
T1150 = 1/uazuaz__;
T1152 = 1/uaz_b__;
lhs =y(37);
rhs =T18*T23*T27;
...
residual(28)= lhs-rhs;
lhs =y(14);
rhs =params(25)*params(14)/(1+params(25))+T453+x(it_, 7)/uazuaz__+x(it_, 8)/uazuaz__+x(it_, 9)/uazuaz__-x(it_, 10)/uazuaz__-x(it_, 11)/uazuaz__-x(it_, 12)/uazuaz__;
residual(29)= lhs-rhs;
lhs =y(12);
...
if nargout >= 2,
  ...
  g1(4,35)=(-1);
  g1(5,29)=1;
  g1(5,31)=(-((1-params(55)-params(56))*getPowerDeriv(y(31),1-params(21),1)*T906));
  g1(5,33)=(-(T906*params(56)*getPowerDeriv(y(33),1-params(21),1)));
  g1(5,34)=(-(T906*params(55)*getPowerDeriv(y(34),1-params(21),1)));
  g1(6,16)=(-(y(51)/y(55)*1/y(29)))/(T87*T87)*T670;
  g1(6,51)=T670*1/y(55)/T87;
  ...
  g1(6,29)=T670*(-(y(51)/y(55)*(-y(16))/(y(29)*y(29))))/(T87*T87);
  g1(6,55)=T670*(-y(51))/(y(55)*y(55))/T87;
  ...
  g1(7,30)=T118*T886;
  g1(7,56)=T118*T893-(-y(58))/(y(56)*y(56));
  ...
  g1(8,30)=T146*T886;
  g1(8,56)=T146*T893-(-y(57))/(y(56)*y(56));
  ...
  g1(18,16)=(-compn__);
  g1(18,17)=(-compn__);
  g1(18,21)=(-(params(1)*T702));
  g1(18,22)=(-(params(1)*T723));
  g1(18,23)=(-(params(5)*abcap__+y(23)*params(5)*T746));
  g1(18,5)=(-(params(1)*T770));
  g1(18,6)=(-(params(1)*T801));
  ...
  g1(20,21)=(-(y(30)*T702));
  g1(20,22)=(-(y(30)*T723));
  g1(20,23)=(-(y(32)*abcap__+y(23)*y(32)*T746));
  g1(20,5)=(-(y(30)*T770));
  g1(20,6)=(-(y(30)*T801));
  g1(20,28)=1;
  ...
  g1(29,14)=1;
  g1(29,48)=(-((-(x(it_, 7)*T1031))/(uazuaz__*uazuaz__)+(-(x(it_, 8)*T1031))/(uazuaz__*uazuaz__)+(-(x(it_, 9)*T1031))/(uazuaz__*uazuaz__)-(-(x(it_, 10)*T1031))/(uazuaz__*uazuaz__)-(-(x(it_, 11)*T1031))/(uazuaz__*uazuaz__)-(-(x(it_, 12)*T1031))/(uazuaz__*uazuaz__)));
  g1(29,65)=(-T1150);
  g1(29,66)=(-T1150);
  g1(29,67)=(-T1150);
  g1(29,68)=T1150;
  ...
  g1(30,48)=(-((-(x(it_, 19)*T1058))/(uaz_b__*uaz_b__)+(-(x(it_, 20)*T1058))/(uaz_b__*uaz_b__)+(-(x(it_, 21)*T1058))/(uaz_b__*uaz_b__)-(-(x(it_, 22)*T1058))/(uaz_b__*uaz_b__)-(-(x(it_, 23)*T1058))/(uaz_b__*uaz_b__)-(-(x(it_, 24)*T1058))/(uaz_b__*uaz_b__)));
  g1(30,77)=(-T1152);
  g1(30,78)=(-T1152);
  g1(30,79)=(-T1152);
  g1(30,80)=T1152;
  ...
  g1(31,15)=1;
  g1(31,48)=(-((-(x(it_, 13)*T1031))/(uazuaz__*uazuaz__)+(-(x(it_, 14)*T1031))/(uazuaz__*uazuaz__)+(-(x(it_, 15)*T1031))/(uazuaz__*uazuaz__)-(-(x(it_, 16)*T1031))/(uazuaz__*uazuaz__)-(-(x(it_, 17)*T1031))/(uazuaz__*uazuaz__)-(-(x(it_, 18)*T1031))/(uazuaz__*uazuaz__)));
  g1(31,71)=(-T1150);
  g1(31,72)=(-T1150);
  g1(31,73)=(-T1150);
  g1(31,74)=T1150;
  ...
  g1(36,39)=T453;
  g1(36,48)=(-((-(int_repayment__*T1031))/(uazuaz__*uazuaz__)));
  g1(36,131)=(-T1150);
  g1(36,132)=(-T1150);
  g1(37,33)=1;
  g1(37,113)=(-1);
