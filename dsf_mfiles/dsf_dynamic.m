...
int_repayment__ = x(it_, 37)+x(it_, 38);
...
T599 = getPowerDeriv(T88,1/params(66),1);
T631 = 1+y(5)*T162*1/y(5)*2*(y(21)/y(5)-params(16)-params(25));
T652 = 1+y(6)*T134*1/y(6)*2*(y(22)/y(6)-params(17)-params(25));
T668 = getPowerDeriv(1+y(23)/y(10)-params(18)-params(25),params(47),1);
T675 = (y(23)*(T235+(y(23)-params(76)*(params(25)+params(18)))*1/y(10)*T668)-(params(76)*(params(25)+params(18))+T235*(y(23)-params(76)*(params(25)+params(18)))))/(y(23)*y(23));
T699 = T162*(y(21)/y(5)-params(16)-params(25))^2+y(5)*T162*2*(y(21)/y(5)-params(16)-params(25))*(-y(21))/(y(5)*y(5));
T730 = T134*(y(22)/y(6)-params(17)-params(25))^2+y(6)*T134*2*(y(22)/y(6)-params(17)-params(25))*(-y(22))/(y(6)*y(6));
T803 = (1+y(38))*y(55)/y(29)*1/y(56);
T810 = (1+y(38))*y(55)/y(29)*(-y(30))/(y(56)*y(56));
T823 = getPowerDeriv(T79,1/(1-params(21)),1);
T923 = (-(params(3)/(1+params(3))/(1+y(20))));
T944 = (-params(74))/(y(48)*y(48));
T959 = (-(y(29)*params(74)))/(y(48)*y(48));
T1000 = (y(23)-params(76)*(params(25)+params(18)))*T668*(-y(23))/(y(10)*y(10))/y(23);
T1024 = (-(1/uazuaz__));
lhs =y(37);
rhs =T18*T23*T27;
residual(1)= lhs-rhs;
...
residual(28)= lhs-rhs;
lhs =y(14);
rhs =params(25)*params(14)/(1+params(25))+T453+x(it_, 4)/uazuaz__+x(it_, 5)/uazuaz__+x(it_, 6)/uazuaz__;
residual(29)= lhs-rhs;
lhs =y(12);
...
if nargout >= 2,
  ...
  g1(4,35)=(-1);
  g1(5,29)=1;
  g1(5,31)=(-((1-params(55)-params(56))*getPowerDeriv(y(31),1-params(21),1)*T823));
  g1(5,33)=(-(T823*params(56)*getPowerDeriv(y(33),1-params(21),1)));
  g1(5,34)=(-(T823*params(55)*getPowerDeriv(y(34),1-params(21),1)));
  g1(6,16)=(-(y(51)/y(55)*1/y(29)))/(T87*T87)*T599;
  g1(6,51)=T599*1/y(55)/T87;
  ...
  g1(6,29)=T599*(-(y(51)/y(55)*(-y(16))/(y(29)*y(29))))/(T87*T87);
  g1(6,55)=T599*(-y(51))/(y(55)*y(55))/T87;
  ...
  g1(7,30)=T118*T803;
  g1(7,56)=T118*T810-(-y(58))/(y(56)*y(56));
  ...
  g1(8,30)=T146*T803;
  g1(8,56)=T146*T810-(-y(57))/(y(56)*y(56));
  ...
  g1(18,16)=(-compn__);
  g1(18,17)=(-compn__);
  g1(18,21)=(-(params(1)*T631));
  g1(18,22)=(-(params(1)*T652));
  g1(18,23)=(-(params(5)*abcap__+y(23)*params(5)*T675));
  g1(18,5)=(-(params(1)*T699));
  g1(18,6)=(-(params(1)*T730));
  ...
  g1(20,21)=(-(y(30)*T631));
  g1(20,22)=(-(y(30)*T652));
  g1(20,23)=(-(y(32)*abcap__+y(23)*y(32)*T675));
  g1(20,5)=(-(y(30)*T699));
  g1(20,6)=(-(y(30)*T730));
  g1(20,28)=1;
  ...
  g1(26,18)=1;
  g1(26,19)=1;
  g1(26,23)=(-(y(32)*abcap__+y(23)*y(32)*T675));
  g1(26,28)=1;
  ...
  g1(29,14)=1;
  g1(29,48)=(-((-(x(it_, 4)*T944))/(uazuaz__*uazuaz__)+(-(x(it_, 5)*T944))/(uazuaz__*uazuaz__)+(-(x(it_, 6)*T944))/(uazuaz__*uazuaz__)));
  g1(29,62)=T1024;
  g1(29,63)=T1024;
  g1(29,64)=T1024;
  ...
  g1(30,48)=(-((-(x(it_, 10)*T959))/(uaz_b__*uaz_b__)+(-(x(it_, 11)*T959))/(uaz_b__*uaz_b__)+(-(x(it_, 12)*T959))/(uaz_b__*uaz_b__)));
  g1(30,68)=(-(1/uaz_b__));
  g1(30,69)=(-(1/uaz_b__));
  g1(30,70)=(-(1/uaz_b__));
  g1(31,4)=(-(1/(1+params(25))));
  g1(31,15)=1;
  g1(31,48)=(-((-(x(it_, 7)*T944))/(uazuaz__*uazuaz__)+(-(x(it_, 8)*T944))/(uazuaz__*uazuaz__)+(-(x(it_, 9)*T944))/(uazuaz__*uazuaz__)));
  g1(31,65)=T1024;
  g1(31,66)=T1024;
  g1(31,67)=T1024;
  g1(32,23)=uaz__;
  ...
  g1(36,39)=T453;
  g1(36,48)=(-((-(int_repayment__*T944))/(uazuaz__*uazuaz__)));
  g1(36,95)=T1024;
  g1(36,96)=T1024;
  g1(37,33)=1;
  g1(37,86)=(-1);
