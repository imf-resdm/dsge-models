...
residual = zeros(38, 1);
compn__ = (1-params(56)-params(55))*y(37)^(-params(21))/(params(55)*x(it_, 27)^(1-params(21))+params(56)*x(it_, 26)^(1-params(21))+(1-params(56)-params(55))*y(37)^(1-params(21)));
...
T16 = (1-params(56)-params(55))*y(37)^(-params(21));
T24 = params(55)*x(it_, 27)^(1-params(21))+params(56)*x(it_, 26)^(1-params(21));
T27 = T24+(1-params(56)-params(55))*y(37)^(1-params(21));
T35 = params(4)*(y(40)/params(51))^params(65);
T39 = T35*y(14)^params(49);
T44 = y(7)^(params(73)+params(8));
T48 = y(32)^(1-params(8));
T57 = params(2)*(y(39)/params(50))^params(64);
T60 = T57*y(14)^params(48);
T65 = y(6)^(params(72)+params(7));
T69 = y(31)^(1-params(7));
T87 = T24+y(37)^(1-params(21))*(1-params(55)-params(56));
T95 = y(20)/y(35);
T96 = y(53)/y(57)/T95;
T117 = y(36)/y(58);
T118 = (1+y(41))*y(57)/y(35)*T117;
T126 = 1+params(42)*(y(27)/y(7)-params(17)-params(25));
T137 = params(42)*(y(56)/y(30)-params(17)-params(25));
T142 = params(42)/2;
T154 = 1+params(41)*(y(26)/y(6)-params(16)-params(25));
T165 = params(41)*(y(55)/y(29)-params(16)-params(25));
T170 = params(41)/2;
T243 = (1+y(28)/y(13)-params(18)-params(25))^params(47);
T352 = exp(params(23)*(y(17)/y(50)+params(38)*y(18)/y(50)-params(14)/params(74)-params(38)*params(15)/params(74)));
T464 = y(3)/(1+params(25));
T588 = getPowerDeriv(T96,1/params(66),1);
T620 = 1+y(6)*T170*1/y(6)*2*(y(26)/y(6)-params(16)-params(25));
T641 = 1+y(7)*T142*1/y(7)*2*(y(27)/y(7)-params(17)-params(25));
T657 = getPowerDeriv(1+y(28)/y(13)-params(18)-params(25),params(47),1);
T664 = (y(28)*(T243+(y(28)-params(76)*(params(25)+params(18)))*1/y(13)*T657)-(params(76)*(params(25)+params(18))+T243*(y(28)-params(76)*(params(25)+params(18)))))/(y(28)*y(28));
T688 = T170*(y(26)/y(6)-params(16)-params(25))^2+y(6)*T170*2*(y(26)/y(6)-params(16)-params(25))*(-y(26))/(y(6)*y(6));
T719 = T142*(y(27)/y(7)-params(17)-params(25))^2+y(7)*T142*2*(y(27)/y(7)-params(17)-params(25))*(-y(27))/(y(7)*y(7));
T792 = (1+y(41))*y(57)/y(35)*1/y(58);
T799 = (1+y(41))*y(57)/y(35)*(-y(36))/(y(58)*y(58));
T812 = getPowerDeriv(T87,1/(1-params(21)),1);
...
residual(2)= lhs-rhs;
lhs =y(36);
rhs =x(it_, 28)+y(37)*params(1);
residual(3)= lhs-rhs;
lhs =y(38);
rhs =x(it_, 28)+y(37)*params(5);
residual(4)= lhs-rhs;
lhs =y(35);
rhs =T87^(1/(1-params(21)));
residual(5)= lhs-rhs;
lhs =T96^(1/params(66));
rhs =params(11)*(1+y(25))*(1+y(41))/((1+y(54))*(1+params(25)));
residual(6)= lhs-rhs;
lhs =T118*T126;
rhs =y(60)/y(58)+1-params(17)+T137*(1+y(56)/y(30)-params(17))-T142*(y(56)/y(30)-params(17)-params(25))^2;
residual(7)= lhs-rhs;
lhs =T118*T154;
rhs =y(59)/y(58)+1-params(16)+T165*(1+y(55)/y(29)-params(16))-T170*(y(55)/y(29)-params(16)-params(25))^2;
residual(8)= lhs-rhs;
lhs =1+y(43);
...
residual(13)= lhs-rhs;
lhs =y(39)*y(37)*(1-params(7))/y(31);
rhs =y(49);
residual(14)= lhs-rhs;
lhs =y(40)*x(it_, 26)*(1-params(8))/y(32);
rhs =y(49);
residual(15)= lhs-rhs;
lhs =y(39)*y(37)*params(7)/y(6);
rhs =y(45);
residual(16)= lhs-rhs;
lhs =y(40)*x(it_, 26)*params(8)/y(7);
rhs =y(46);
residual(17)= lhs-rhs;
lhs =y(39);
...
rhs =y(20)+y(21)+y(36)*(y(27)+y(26)+ACx__+ACn__)+y(28)*y(38)*abcap__+(1+y(42))*y(3)/(1+params(25))+params(38)*(1+y(12))*y(4)/(1+params(25))+(1+y(11))*y(2)/(1+params(25))+params(22)/2*(y(16)-params(13))^2-y(37)*y(39)-x(it_, 26)*y(40)-(y(23)+y(34))-x(it_, 25);
residual(20)= lhs-rhs;
lhs =y(21);
rhs =(params(37)*y(49)*params(3)+params(3)/(1+params(3))*(x(it_, 25)+y(48)))/(1+y(25));
residual(21)= lhs-rhs;
lhs =y(47);
rhs =(y(39)*y(37)*params(48)+y(40)*x(it_, 26)*params(49))/(y(14)*y(38));
residual(22)= lhs-rhs;
lhs =y(44);
...
if nargout >= 2,
  ...
  g1(1,7)=(-(T48*T39*getPowerDeriv(y(7),params(73)+params(8),1)));
  g1(1,32)=(-(T39*T44*getPowerDeriv(y(32),1-params(8),1)));
  g1(1,40)=1-T48*T44*y(14)^params(49)*params(4)*1/params(51)*getPowerDeriv(y(40)/params(51),params(65),1);
  g1(1,14)=(-(T48*T44*T35*getPowerDeriv(y(14),params(49),1)));
  g1(2,6)=(-(T69*T60*getPowerDeriv(y(6),params(72)+params(7),1)));
  g1(2,31)=(-(T60*T65*getPowerDeriv(y(31),1-params(7),1)));
  g1(2,39)=1-T69*T65*y(14)^params(48)*params(2)*1/params(50)*getPowerDeriv(y(39)/params(50),params(64),1);
  g1(2,14)=(-(T69*T65*T57*getPowerDeriv(y(14),params(48),1)));
  g1(3,36)=1;
  g1(3,37)=(-params(1));
  g1(3,88)=(-1);
  g1(4,37)=(-params(5));
  ...
  g1(6,20)=(-(y(53)/y(57)*1/y(35)))/(T95*T95)*T588;
  g1(6,53)=T588*1/y(57)/T95;
  ...
  g1(6,35)=T588*(-(y(53)/y(57)*(-y(20))/(y(35)*y(35))))/(T95*T95);
  g1(6,57)=T588*(-y(53))/(y(57)*y(57))/T95;
  g1(6,41)=(-(params(11)*(1+y(25))/((1+y(54))*(1+params(25)))));
  g1(7,27)=T118*params(42)*1/y(7);
  g1(7,56)=(-((1+y(56)/y(30)-params(17))*params(42)*1/y(30)+T137*1/y(30)-T142*1/y(30)*2*(y(56)/y(30)-params(17)-params(25))));
  g1(7,7)=T118*params(42)*(-y(27))/(y(7)*y(7));
  g1(7,30)=(-((1+y(56)/y(30)-params(17))*params(42)*(-y(56))/(y(30)*y(30))+T137*(-y(56))/(y(30)*y(30))-T142*2*(y(56)/y(30)-params(17)-params(25))*(-y(56))/(y(30)*y(30))));
  g1(7,35)=T126*T117*(1+y(41))*(-y(57))/(y(35)*y(35));
  g1(7,57)=T126*T117*(1+y(41))*1/y(35);
  g1(7,36)=T126*T792;
  g1(7,58)=T126*T799-(-y(60))/(y(58)*y(58));
  g1(7,41)=T126*y(57)/y(35)*T117;
  g1(7,60)=(-(1/y(58)));
  g1(8,26)=T118*params(41)*1/y(6);
  g1(8,55)=(-((1+y(55)/y(29)-params(16))*params(41)*1/y(29)+T165*1/y(29)-T170*1/y(29)*2*(y(55)/y(29)-params(16)-params(25))));
  g1(8,6)=T118*params(41)*(-y(26))/(y(6)*y(6));
  g1(8,29)=(-((1+y(55)/y(29)-params(16))*params(41)*(-y(55))/(y(29)*y(29))+T165*(-y(55))/(y(29)*y(29))-T170*2*(y(55)/y(29)-params(16)-params(25))*(-y(55))/(y(29)*y(29))));
  g1(8,35)=T154*T117*(1+y(41))*(-y(57))/(y(35)*y(35));
  g1(8,57)=T154*T117*(1+y(41))*1/y(35);
  g1(8,36)=T154*T792;
  g1(8,58)=T154*T799-(-y(59))/(y(58)*y(58));
  g1(8,41)=T154*y(57)/y(35)*T117;
  g1(8,59)=(-(1/y(58)));
  ...
  g1(13,51)=(-params(59));
  g1(13,52)=1;
  g1(14,31)=(-(y(39)*y(37)*(1-params(7))))/(y(31)*y(31));
  g1(14,37)=y(39)*(1-params(7))/y(31);
  g1(14,39)=y(37)*(1-params(7))/y(31);
  g1(14,49)=(-1);
  g1(15,32)=(-(y(40)*x(it_, 26)*(1-params(8))))/(y(32)*y(32));
  g1(15,40)=x(it_, 26)*(1-params(8))/y(32);
  g1(15,49)=(-1);
  g1(15,86)=y(40)*(1-params(8))/y(32);
  g1(16,6)=(-(y(39)*y(37)*params(7)))/(y(6)*y(6));
  g1(16,37)=y(39)*params(7)/y(6);
  g1(16,39)=y(37)*params(7)/y(6);
  g1(16,45)=(-1);
  g1(17,7)=(-(y(40)*x(it_, 26)*params(8)))/(y(7)*y(7));
  g1(17,40)=x(it_, 26)*params(8)/y(7);
  g1(17,46)=(-1);
  ...
  g1(18,37)=(-((y(20)+y(21))*(T27*(1-params(56)-params(55))*getPowerDeriv(y(37),(-params(21)),1)-T16*(1-params(56)-params(55))*getPowerDeriv(y(37),1-params(21),1))/(T27*T27)));
  g1(18,39)=1;
  g1(18,13)=(-(y(28)*params(5)*T976));
  g1(18,86)=(-((y(20)+y(21))*(-(T16*params(56)*getPowerDeriv(x(it_, 26),1-params(21),1)))/(T27*T27)));
  g1(18,87)=(-((y(20)+y(21))*(-(T16*params(55)*getPowerDeriv(x(it_, 27),1-params(21),1)))/(T27*T27)));
  g1(19,31)=1;
  g1(19,32)=1;
  ...
  g1(22,38)=(-((-(y(14)*(y(39)*y(37)*params(48)+y(40)*x(it_, 26)*params(49))))/(y(14)*y(38)*y(14)*y(38))));
  g1(22,39)=(-(y(37)*params(48)/(y(14)*y(38))));
  g1(22,40)=(-(x(it_, 26)*params(49)/(y(14)*y(38))));
  g1(22,47)=1;
  g1(22,14)=(-((-(y(38)*(y(39)*y(37)*params(48)+y(40)*x(it_, 26)*params(49))))/(y(14)*y(38)*y(14)*y(38))));
