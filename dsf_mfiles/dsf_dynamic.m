...
T668 = getPowerDeriv(T88,1/params(66),1);
T700 = 1+y(5)*T162*1/y(5)*2*(y(21)/y(5)-params(16)-params(25));
T721 = 1+y(6)*T134*1/y(6)*2*(y(22)/y(6)-params(17)-params(25));
T737 = getPowerDeriv(1+y(23)/y(10)-params(18)-params(25),params(47),1);
T744 = (y(23)*(T235+(y(23)-params(76)*(params(25)+params(18)))*1/y(10)*T737)-(params(76)*(params(25)+params(18))+T235*(y(23)-params(76)*(params(25)+params(18)))))/(y(23)*y(23));
T768 = T162*(y(21)/y(5)-params(16)-params(25))^2+y(5)*T162*2*(y(21)/y(5)-params(16)-params(25))*(-y(21))/(y(5)*y(5));
T799 = T134*(y(22)/y(6)-params(17)-params(25))^2+y(6)*T134*2*(y(22)/y(6)-params(17)-params(25))*(-y(22))/(y(6)*y(6));
T884 = (1+y(38))*y(55)/y(29)*1/y(56);
T891 = (1+y(38))*y(55)/y(29)*(-y(30))/(y(56)*y(56));
T904 = getPowerDeriv(T79,1/(1-params(21)),1);
T1004 = (-(params(3)/(1+params(3))/(1+y(20))));
T1025 = (-params(74))/(y(48)*y(48));
T1052 = (-(y(29)*params(74)))/(y(48)*y(48));
T1117 = (y(23)-params(76)*(params(25)+params(18)))*T737*(-y(23))/(y(10)*y(10))/y(23);
T1140 = 1/uazuaz__;
T1142 = 1/uaz_b__;
lhs =y(37);
rhs =T18*T23*T27;
...
residual(31)= lhs-rhs;
lhs =y(23)*uaz__;
rhs =params(76)*(params(25)+params(18))+x(it_, 1)+x(it_, 2)+x(it_, 3)-x(it_, 4)-x(it_, 5)-x(it_, 6);
residual(32)= lhs-rhs;
lhs =y(19)*uazuaz__;
...
if nargout >= 2,
  ...
  g1(4,35)=(-1);
  g1(5,29)=1;
  g1(5,31)=(-((1-params(55)-params(56))*getPowerDeriv(y(31),1-params(21),1)*T904));
  g1(5,33)=(-(T904*params(56)*getPowerDeriv(y(33),1-params(21),1)));
  g1(5,34)=(-(T904*params(55)*getPowerDeriv(y(34),1-params(21),1)));
  g1(6,16)=(-(y(51)/y(55)*1/y(29)))/(T87*T87)*T668;
  g1(6,51)=T668*1/y(55)/T87;
  ...
  g1(6,29)=T668*(-(y(51)/y(55)*(-y(16))/(y(29)*y(29))))/(T87*T87);
  g1(6,55)=T668*(-y(51))/(y(55)*y(55))/T87;
  ...
  g1(7,30)=T118*T884;
  g1(7,56)=T118*T891-(-y(58))/(y(56)*y(56));
  ...
  g1(8,30)=T146*T884;
  g1(8,56)=T146*T891-(-y(57))/(y(56)*y(56));
  ...
  g1(18,16)=(-compn__);
  g1(18,17)=(-compn__);
  g1(18,21)=(-(params(1)*T700));
  g1(18,22)=(-(params(1)*T721));
  g1(18,23)=(-(params(5)*abcap__+y(23)*params(5)*T744));
  g1(18,5)=(-(params(1)*T768));
  g1(18,6)=(-(params(1)*T799));
  ...
  g1(20,21)=(-(y(30)*T700));
  g1(20,22)=(-(y(30)*T721));
  g1(20,23)=(-(y(32)*abcap__+y(23)*y(32)*T744));
  g1(20,5)=(-(y(30)*T768));
  g1(20,6)=(-(y(30)*T799));
  g1(20,28)=1;
  ...
  g1(26,18)=1;
  g1(26,19)=1;
  g1(26,23)=(-(y(32)*abcap__+y(23)*y(32)*T744));
  g1(26,28)=1;
  ...
  g1(29,14)=1;
  g1(29,48)=(-((-(x(it_, 7)*T1025))/(uazuaz__*uazuaz__)+(-(x(it_, 8)*T1025))/(uazuaz__*uazuaz__)+(-(x(it_, 9)*T1025))/(uazuaz__*uazuaz__)-(-(x(it_, 10)*T1025))/(uazuaz__*uazuaz__)-(-(x(it_, 11)*T1025))/(uazuaz__*uazuaz__)-(-(x(it_, 12)*T1025))/(uazuaz__*uazuaz__)));
  g1(29,65)=(-T1140);
  g1(29,66)=(-T1140);
  g1(29,67)=(-T1140);
  g1(29,68)=T1140;
  ...
  g1(30,48)=(-((-(x(it_, 19)*T1052))/(uaz_b__*uaz_b__)+(-(x(it_, 20)*T1052))/(uaz_b__*uaz_b__)+(-(x(it_, 21)*T1052))/(uaz_b__*uaz_b__)-(-(x(it_, 22)*T1052))/(uaz_b__*uaz_b__)-(-(x(it_, 23)*T1052))/(uaz_b__*uaz_b__)-(-(x(it_, 24)*T1052))/(uaz_b__*uaz_b__)));
  g1(30,77)=(-T1142);
  g1(30,78)=(-T1142);
  g1(30,79)=(-T1142);
  g1(30,80)=T1142;
  ...
  g1(31,15)=1;
  g1(31,48)=(-((-(x(it_, 13)*T1025))/(uazuaz__*uazuaz__)+(-(x(it_, 14)*T1025))/(uazuaz__*uazuaz__)+(-(x(it_, 15)*T1025))/(uazuaz__*uazuaz__)-(-(x(it_, 16)*T1025))/(uazuaz__*uazuaz__)-(-(x(it_, 17)*T1025))/(uazuaz__*uazuaz__)-(-(x(it_, 18)*T1025))/(uazuaz__*uazuaz__)));
  g1(31,71)=(-T1140);
  g1(31,72)=(-T1140);
  g1(31,73)=(-T1140);
  g1(31,74)=T1140;
  ...
  g1(36,39)=T453;
  g1(36,48)=(-((-(int_repayment__*T1025))/(uazuaz__*uazuaz__)));
  g1(36,131)=(-T1140);
  g1(36,132)=(-T1140);
  g1(37,33)=1;
  g1(37,113)=(-1);
