...
T24 = params(55)*x(27)^(1-params(21))+params(56)*x(26)^(1-params(21));
T27 = T24+(1-params(56)-params(55))*y(23)^(1-params(21));
T31 = params(42)/2;
T43 = params(41)/2;
T63 = (1+y(14)/y(37)-params(18)-params(25))^params(47);
...
T248 = T24+y(23)^(1-params(21))*(1-params(55)-params(56));
T262 = params(42)*(y(13)/y(16)-params(17)-params(25));
T273 = T31*(y(13)/y(16)-params(17)-params(25))^2;
T276 = params(41)*(y(12)/y(15)-params(16)-params(25));
T287 = T43*(y(12)/y(15)-params(16)-params(25))^2;
...
T598 = (y(14)*(T63+(y(14)-params(76)*(params(25)+params(18)))*1/y(37)*T591)-(params(76)*(params(25)+params(18))+T63*(y(14)-params(76)*(params(25)+params(18)))))/(y(14)*y(14));
...
if nargout >= 2,
  ...
  g1(7,13)=(1+y(27))*params(42)*1/y(16)-((1+y(13)/y(16)-params(17))*params(42)*1/y(16)+T262*1/y(16)-T31*T580);
  g1(7,16)=(1+y(27))*params(42)*(-y(13))/(y(16)*y(16))-((1+y(13)/y(16)-params(17))*params(42)*(-y(13))/(y(16)*y(16))+T262*(-y(13))/(y(16)*y(16))-T31*T644);
  g1(7,22)=(-((-y(32))/(y(22)*y(22))));
  g1(7,27)=1+T262;
  g1(7,32)=(-(1/y(22)));
  g1(8,12)=(1+y(27))*params(41)*1/y(15)-((1+y(12)/y(15)-params(16))*params(41)*1/y(15)+T276*1/y(15)-T43*T563);
  g1(8,15)=(1+y(27))*params(41)*(-y(12))/(y(15)*y(15))-((1+y(12)/y(15)-params(16))*params(41)*(-y(12))/(y(15)*y(15))+T276*(-y(12))/(y(15)*y(15))-T43*T619);
  ...
  g1(18,6)=(-compn__);
  g1(18,7)=(-compn__);
  g1(18,12)=(-(params(1)*(1+y(15)*T43*T563)));
  g1(18,13)=(-(params(1)*(1+y(16)*T31*T580)));
  g1(18,14)=(-(abcap__*params(5)+y(14)*params(5)*T598));
  g1(18,15)=(-(params(1)*(T287+y(15)*T43*T619)));
  g1(18,16)=(-(params(1)*(T273+y(16)*T31*T644)));
  g1(18,23)=(-((y(6)+y(7))*(T27*(1-params(56)-params(55))*getPowerDeriv(y(23),(-params(21)),1)-(1-params(56)-params(55))*y(23)^(-params(21))*(1-params(56)-params(55))*getPowerDeriv(y(23),1-params(21),1))/(T27*T27)));
  g1(18,25)=1;
  ...
  g1(20,7)=(-1);
  g1(20,9)=1;
  g1(20,12)=(-(y(22)*(1+y(15)*T43*T563)));
  g1(20,13)=(-(y(22)*(1+y(16)*T31*T580)));
  g1(20,14)=(-(y(24)*abcap__+y(14)*y(24)*T598));
  g1(20,15)=(-(y(22)*(T287+y(15)*T43*T619)));
  g1(20,16)=(-(y(22)*(T273+y(16)*T31*T644)));
  g1(20,20)=1;
