...
T1__ = y(19)+params(49)*(T_target__-y(19))-params(50)*(y(27)-x(26));
h1__ = y(18)+params(47)*(h_target__-y(18))+(y(27)-x(26))*params(48)/(y(16)*y(2)+x(23)*y(1));
hbar_staggered__ = params(57)+x(16)+x(17)+x(18);
h_capped__ = min(h1__,params(52));
Tbar_staggered__ = params(60)+x(19)+x(20)+x(21);
...
T568 = (-params(56))/(y(3)*y(3));
T604 = (-y(9))/(y(5)*y(5))*2*(y(9)/y(5)-params(3)-params(29));
T630 = (-y(10))/(y(6)*y(6))*2*(y(10)/y(6)-params(4)-params(29));
T661 = 2*(y(9)/y(5)-params(3)-params(29))*1/y(5);
T677 = 2*(y(10)/y(6)-params(4)-params(29))*1/y(6);
T780 = getPowerDeriv(1+y(22)/y(20)-params(5)-params(29),params(32),1);
T783 = (y(22)-(params(29)+params(5))*params(63))*(-y(22))/(y(20)*y(20))*T780/y(22);
T812 = (y(22)*(T63+(y(22)-(params(29)+params(5))*params(63))*T780*1/y(20))-((params(29)+params(5))*params(63)+T63*(y(22)-(params(29)+params(5))*params(63))))/(y(22)*y(22));
T883 = (-(params(53)*(params(52)>h1__)*params(47)*(-((1-params(46))*y(24)))/((y(31)+y(32))*(y(31)+y(32)))));
lhs =y(1);
rhs =T222*T226*T230;
residual(1)= lhs-rhs;
lhs =y(2);
...
rhs =params(29);
residual(26)= lhs-rhs;
lhs =(y(31)+y(32))*(y(18)-params(57))-(y(19)-params(60));
rhs =DD__;
residual(27)= lhs-rhs;
lhs =y(24);
rhs =(y(31)+y(32))*(y(18)-params(57))-(y(19)-params(60));
residual(28)= lhs-rhs;
lhs =y(18);
...
if nargout >= 2,
  ...
  g1(7,5)=(1+y(33))*params(18)*(-y(9))/(y(5)*y(5))-((1+y(9)/y(5)-params(3))*params(18)*(-y(9))/(y(5)*y(5))+T279*(-y(9))/(y(5)*y(5))-T9*T604);
  g1(7,9)=(1+y(33))*params(18)*1/y(5)-((1+y(9)/y(5)-params(3))*params(18)*1/y(5)+T279*1/y(5)-T9*T661);
  g1(7,11)=(-(1/y(14)));
  g1(7,14)=(-((-y(11))/(y(14)*y(14))));
  g1(7,33)=1+T279;
  g1(8,6)=(1+y(33))*params(19)*(-y(10))/(y(6)*y(6))-((1+y(10)/y(6)-params(4))*params(19)*(-y(10))/(y(6)*y(6))+T293*(-y(10))/(y(6)*y(6))-T21*T630);
  g1(8,10)=(1+y(33))*params(19)*1/y(6)-((1+y(10)/y(6)-params(4))*params(19)*1/y(6)+T293*1/y(6)-T21*T677);
  g1(8,12)=(-(1/y(14)));
  ...
  g1(17,11)=(-1);
  g1(18,2)=1;
  g1(18,5)=(-(params(10)*(T290+T9*y(5)*T604)));
  g1(18,6)=(-(params(10)*(T304+T21*y(6)*T630)));
  g1(18,9)=(-(params(10)*(1+T9*y(5)*T661)));
  g1(18,10)=(-(params(10)*(1+T21*y(6)*T677)));
  ...
  g1(18,20)=(-(y(22)*params(11)*T783));
  g1(18,22)=(-(Jimz__*params(11)+y(22)*params(11)*T812));
  g1(18,31)=(-compn__);
  g1(18,32)=(-compn__);
  g1(19,7)=1;
  g1(19,8)=1;
  g1(20,1)=x(23);
  g1(20,2)=y(16);
  g1(20,5)=(-(y(14)*(T290+T9*y(5)*T604)));
  g1(20,6)=(-(y(14)*(T304+T21*y(6)*T630)));
  g1(20,9)=(-(y(14)*(1+T9*y(5)*T661)));
  g1(20,10)=(-(y(14)*(1+T21*y(6)*T677)));
  g1(20,14)=(-(y(9)+y(10)+Robx__+Robn__));
  g1(20,15)=(-(y(22)*Jimz__));
  g1(20,16)=y(2);
  g1(20,20)=(-(y(22)*y(15)*T783));
  g1(20,22)=(-(y(15)*Jimz__+y(22)*y(15)*T812));
  ...
  g1(27,18)=y(31)+y(32);
  g1(27,19)=(-1);
  g1(27,20)=(-(y(22)*y(15)*T783));
  g1(27,21)=params(33);
  g1(27,22)=(-(y(15)*Jimz__+y(22)*y(15)*T812));
  g1(27,26)=(-(y(17)*(1+y(33))/(1+params(29))-y(17)));
  g1(27,27)=(-(params(42)*(1+y(36))/(1+params(29))-params(42)));
  g1(27,28)=(-((1+y(34))/(1+params(29))-1));
  g1(27,31)=y(18)-params(57)-(-params(57));
  g1(27,32)=y(18)-params(57)-(-params(57));
  g1(27,33)=(-(y(17)*y(26)/(1+params(29))));
  g1(27,34)=(-(y(28)/(1+params(29))));
  ...
  g1(28,19)=1;
  g1(28,24)=1;
  g1(28,31)=(-(y(18)-params(57)));
  g1(28,32)=(-(y(18)-params(57)));
  g1(29,1)=(-(params(53)*(-(x(23)*(y(27)-x(26))*params(48)))/((y(16)*y(2)+x(23)*y(1))*(y(16)*y(2)+x(23)*y(1)))*(params(52)>h1__)));
  g1(29,2)=(-(params(53)*(params(52)>h1__)*(-(y(16)*(y(27)-x(26))*params(48)))/((y(16)*y(2)+x(23)*y(1))*(y(16)*y(2)+x(23)*y(1)))));
  g1(29,16)=(-(params(53)*(params(52)>h1__)*(-((y(27)-x(26))*params(48)*y(2)))/((y(16)*y(2)+x(23)*y(1))*(y(16)*y(2)+x(23)*y(1)))));
  g1(29,18)=1-params(53)*(params(52)>h1__)*(1-params(47));
  g1(29,24)=(-(params(53)*(params(52)>h1__)*params(47)*(1-params(46))/(y(31)+y(32))));
  g1(29,27)=(-(params(53)*(params(52)>h1__)*params(48)/(y(16)*y(2)+x(23)*y(1))));
  g1(29,31)=T883;
  g1(29,32)=T883;
  g1(30,19)=1-params(54)*(1-params(49))*(T1__>params(51));
  g1(30,24)=(-(params(54)*(T1__>params(51))*params(49)*(-params(46))));
  g1(30,27)=(-(params(54)*(T1__>params(51))*(-params(50))));
  g1(31,26)=1;
  g1(32,3)=(-((-(x(4)*T568))/(uazuaz__*uazuaz__)+(-(x(5)*T568))/(uazuaz__*uazuaz__)+(-(x(6)*T568))/(uazuaz__*uazuaz__)));
  g1(32,28)=1-1/(1+params(29));
  g1(33,30)=1;
  ...
  g1(37,3)=y(38)*T568;
  g1(37,38)=uazuaz__;
  g1(38,3)=(-((-(int_repayment__*T568))/(uazuaz__*uazuaz__)));
